...
public class CollegeNoticesFragment extends Fragment {
    String collegeID;
    View v;
    TextView tvNoItem;
    ...
    public CollegeNoticesFragment(String collegeID) {
        this.collegeID=collegeID;
    }


    // TODO: Rename and change types and number of parameters
    public static CollegeNoticesFragment newInstance(String param1, String param2) {
        CollegeNoticesFragment fragment = new CollegeNoticesFragment();
        return fragment;
    }
