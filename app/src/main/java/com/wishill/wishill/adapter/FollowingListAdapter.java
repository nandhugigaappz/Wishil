...
public class FollowingListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    List<UserFollowingData> list;
    public ItemClickAdapterListener onClickListener;
    boolean loadMore;

    public FollowingListAdapter(boolean loadMore, List<UserFollowingData> list, Context context, ItemClickAdapterListener onClickListener) {
        this.list = list;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ListHolder) {
            ...
            vh1.tvSubTitle.setText(list.get(position).getCity());
