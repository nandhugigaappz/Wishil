...
public class StudyAbrodCountryAdapter extends RecyclerView.Adapter<StudyAbrodCountryAdapter.ViewHolder> {
    List<StudyAbrodCountiresListData> list;
    public ItemClickAdapterListener onClickListener;

    public StudyAbrodCountryAdapter( List<StudyAbrodCountiresListData> list, Context context, ItemClickAdapterListener onClickListener) {
        this.list = list;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tvName.setText(list.get(position).getCountryName());
