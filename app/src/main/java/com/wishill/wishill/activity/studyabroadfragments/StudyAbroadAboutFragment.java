package com.wishill.wishill.activity.studyabroadfragments;
...
public class StudyAbroadAboutFragment extends Fragment{
    ...
    StudyAbroadBasicDetailsData collegeDetailsData;
    ...
    public StudyAbroadAboutFragment(StudyAbroadBasicDetailsData collegeDetailsData) {
        this.collegeDetailsData=collegeDetailsData;
    }


    public static StudyAbroadAboutFragment newInstance(String param1, String param2) {
        StudyAbroadAboutFragment fragment = new StudyAbroadAboutFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_study_abroad_about, container, false);
